export default {
  ...
  orders: {
    ...
    noSubmittedOrders: 'まだ提出された再度在庫補充注文はありません',
    totalOrders: '総注文数',
    totalRevenue: '総収益',
    avgOrderValue: '平均注文額',
    onTimeDelivery: '定時配達',
  ...
  restocking: {
    title: '再度在庫補充',
    description: '予算を設定して、需要予測に基づくAIの在庫補充提案を受け取ります',
    budget: '利用可能な予算',
    recommendations: '提案',
    noRecommendations: '予算内で在庫補充が必要な品目はありません',
    budgetUsed: '使用済み予算',
    remaining: '残り',
    placeOrder: '注文を配置',
    orderSubmitted: '再度在庫補充注文が送信されました！',
    orderNumber: '注文番号',
    leadTime: '予想リードタイム',
    totalValue: '合計金額',
    table: {
